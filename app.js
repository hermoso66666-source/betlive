...
$("#showBets").onclick=()=>{$("#events").classList.add("hidden");$("#bets").classList.remove("hidden");loadTickets("all")};$("#showLive").onclick=()=>{$("#bets").classList.add("hidden");$("#events").classList.remove("hidden")};
